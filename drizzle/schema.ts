import { pgTable, unique, serial, varchar, text, timestamp, uuid, numeric } from "drizzle-orm/pg-core"
...
export const users = pgTable("users", {
	...
	fechaCreacion: timestamp("fecha_creacion", { mode: 'string' }).defaultNow().notNull(),
}, (table) => [
